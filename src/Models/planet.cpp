...
namespace Model{
        ...
        const double planet::getSpeedOfSound() const
        {
            return speedOfSound;
        }
        ...
        void planet::setSpeedOfSound(double newSpeedOfSound)
        {
        ...
        bool planet::operator==(const planet& other) const{
            ...
            if (this->getMaxWindSpeed() != other.getMaxWindSpeed())
                return false;
            if (this->getSpeedOfSound() != other.getSpeedOfSound())
                return false;
        ...
        void to_json(nlohmann::json& j, const planet& p){
            j = nlohmann::json{{"name", p.getName()},
                               ...
                               {"speedOfSound", p.getSpeedOfSound()},
        ...
        void from_json(const nlohmann::json& j, planet& p){
            ...
            p.setSpeedOfSound(j.at("speedOfSound").get<double>());
